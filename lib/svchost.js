...
var SvcHost = (function(){
	 ...
	 * handleRestart(starts, launch): callback with custom logic on retries etc... 
	 8                                returns bool whether to restart
     */
    SvcHost.prototype.start = function(appPath, args, handleRestart) {
    ...
    SvcHost.prototype._launch = function() {
    	this.child = this._spawnApp(this.appPath, this.args);
	...
	SvcHost.prototype._spawnApp = function(appPath, args) {
